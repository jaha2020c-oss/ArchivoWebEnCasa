...
app.post('/guardar-venta', async (req, res) => {
    // AÑADIDO: nombre_cliente recibido desde el frontend
    ...
    try {
        ...
        const resultVenta = await pool.request()
           ...
           .input('metodo_pago', sql.VarChar(20), metodo_pago)
            ...
            .input('nombre_cliente', sql.VarChar(100), nombre_cliente) // Inyección del nombre del popup
...
app.get('/ventas', async (req, res) => {
    try {
        const pool = await poolPromise;
        // AÑADIDO: ISNULL para que prefiera mostrar el nombre_cliente temporal, si no, el del usuario
