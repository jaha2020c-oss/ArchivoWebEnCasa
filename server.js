...
app.post('/guardar-venta', async (req, res) => {
    ...
    try {
        ...
        // CAPTURA DE FECHA EXACTA: Calculamos el tiempo local real de Nicaragua
        const fechaLocalString = new Date().toLocaleString("en-US", { timeZone: "America/Managua" });
        const fechaActual = new Date(fechaLocalString);

        // Registro de la Venta Principal pasando el nuevo parámetro de fecha exacta
