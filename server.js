...
/* --- RUTAS DE NAVEGACIÓN (Evita errores 404 en Render) --- */
...
app.delete('/eliminarPlatillo/:id', async (req, res) => {
    try {
        ...
        await pool.request()
            ...
            .execute('sp_EliminarPlatillo'); // Asegúrate de tener este SP en Azure
        res.send('OK');
    } catch (err) {
...
// Obtener Historial con Cajero (Relación INNER JOIN)
