...
// Middlewares - IMPORTANTE: app.json() debe ir antes de las rutas
app.use(cors());
...
/* --- RUTAS DE NAVEGACIÓN (Corrige el "Cannot GET") --- */
...
app.post('/login', async (req, res) => {
    ...
    try {
        ...
        if (result.recordset.length > 0) {
            ...
            // trim() elimina espacios invisibles que mete SQL
            ...
            res.status(404).json({ success: false, mensaje: "Usuario no existe" });
        }
    } catch (err) {
